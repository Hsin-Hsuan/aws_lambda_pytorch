...
aws s3 cp pytorch_fn.zip s3://hsung2-serverless-project/
aws lambda update-function-code --function-name pytorch_example --s3-bucket hsung2-serverless-project  --s3-key pytorch_fn.zip
